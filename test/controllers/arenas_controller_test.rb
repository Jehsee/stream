...
class ArenasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create arena" do
    assert_difference('Arena.count') do
      post arenas_url, params: { arena: { message_id: @arena.message_id, user_id: @arena.user_id } }
    end
  ...
  test "should update arena" do
    patch arena_url(@arena), params: { arena: { message_id: @arena.message_id, user_id: @arena.user_id } }
